...
const Accom = () => {
  const [image, setImage] = useState({
    backgroundImage: "url('/assets/accom.jpg')",
  ...
  const SwitchImage = (e) => {
    if (e == 1 && lock != 1) {
      setLock(1);
      setImage({
        backgroundImage: "url('/assets/couch.jpg')",
      ...
      setLock(2);
      setImage({
        backgroundImage: "url('/assets/carpet.jpg')",
      ...
      <div className={styles._image} style={image}>
        <div className={styles._overlay}>
          <div className={styles._textSection}>
            <div className={styles._bigText}>WELCOME TO ELYSIUM</div>
